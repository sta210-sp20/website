...
- `room_type`: 
    ...
    - *Private room* (Guests have private room to sleep, all other rooms shared)     - *Shared room* (Guests sleep in room shared with others) 
...
How many observations are in `airbnb`? How many columns?
