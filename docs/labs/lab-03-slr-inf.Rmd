...
2. Let's begin by examining the distribution of the **<i>predictor variable</i>**. Make a histogram to display the distribution of the response variable. Describe the shape of the distribution. 
