---
title: "Lab 09: Multinomial Logistic Regression"
subtitle: "due Thu, Apr 16 at 11:59p EDT"
output: 
  tufte::tufte_html:
    css: "./sta210-labs.css"
...
- Go to the sta210-sp20 organization on GitHub ([https://github.com/sta210-sp20](https://github.com/sta210-sp20)). Click on the repo with the prefix **lab-09-**
...
8. Consider the relationship between age and one's opinion about spending on mass transportation. Interpret the coefficient of age in terms of the <u>odds</u> of having an opinion of "Too little" versus "About right".



10. Now that you have adjusted for some demographic factors, let's examine whether a person's political views has a significant impact on their attitude towards spending on mass transportation.
