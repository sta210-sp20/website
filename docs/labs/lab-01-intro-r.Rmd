...
D
We'd like to start by visualizing the differences in the number of bike rentals across season. Create a side-by-side boxplot to visualize the relationship between `season` and `count`. The code below will help you get started. Be sure to include an informative title along with informative labels for the x and y axes.
