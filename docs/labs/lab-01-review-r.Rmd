...
13. While we have observed a difference in the mean length in trails for those that allow dog-walking versus those that don't, let's assess if there is enough evidence to consider the difference "statistically significant" or if it appears to be due to random chance. We'll begin by conducting a test of the following hypotheses: 

$$H_0: \mu_1 - \mu_2 = 0 \\
H_a: \mu_1 - \mu_2 \neq 0$$


    State the null and alternative hypotheses in words. Write them in the context of this analysis.
