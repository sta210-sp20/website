...
1. Plot a histogram to examine the distribution of `gift_aid`. What is the shape of the distribution? *You can use the [ggplot reference](https://ggplot2.tidyverse.org/reference/) page for more detail about adjusting binwidth in histograms.*
