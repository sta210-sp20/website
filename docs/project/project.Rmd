...
The goal of the write up is to demonstrate your ability to ask meaningful questions and answer them using your regression analysis, that you are proficient in using R, and that you are proficient at interpreting and presenting the results.

**The final write up should be no more than 15 pages.** This does **<u>not</u>** include the Additional Work section.

The final write up should be written as if it will be read by a collaborator in business or research who has an interest in understanding the main results from your analysis. This means your write up should focus on the main conclusions and interesting findings that you derive from your analysis. It should not be a list of every model you tried or the interpretation of every model coefficient. 

**Any feedback you've received about your analysis should be incorporated in the final write up.** 

To help you organize your write up, you can use the following sections: 

- **Section 1: Introduction**
    - This section includes an introduction to the project motivation, data, and research question. It can also include some exploratory data analysis. All of the EDA won't fit in the paper, so focus on the EDA for the response variable and a few other interesting parts and relevant of the EDA. 
    
- **Section 2: Regression Analysis**
    - This section includes a brief description of your modeling process. You can briefly describe how you approached the modeling, how you conducted variable selection, interactions you considered, and any transformations you made to satisify model assumptions. This is also where you will output the final model and a brief discussion of the model assumptions, diagnostics, and any model fit statistics.

- **Section 3: Discussion** 
  - This section includes any relevant prediction and/or conclusions from your mdodel. This should not just be a list of interpretations but rather use the interpretations from the model to support your conclusion. Remember, you are sharing a narrative with a business or research colleague who could potentially use your model to make decisions, so they need to know the key findings not just coefficient interpretations. 
  
- **Section 4: Limitations**
  - This section includes discussion abou issues pertaining to the reliability and validity of your data and/or appropriateness of the regression analysis. This can be 1 - 2 paragraphs on what you would do differently if you were able to start over with the project or if you had more time to continue working on the projec.

- **Section 5: Conclusion**
  -  This section includes a summary of your key results and highlight any final points you wish the reader to learn from the project. It can also include ideas on what to do as a next step in the analysis or other questions you wish to explore after doing this analysis.

- **Section 6: Additional Work**
  - This section includes anything that is not included in the main body of the paper. This could be additional EDA, other models you've tried, additional analysis, etc. There is no page limit on the additional work, but it should still be neatly organized and easy for the reader to navigate, if they choose to read it. This means using clearly labeled headers and other best practices (e.g. don't print large tables). 
  
Put the final write up in a .Rmd file called "final-writeup.Rmd" in your `project` folder on GitHub, and output it as a PDF. All code and warning messages should be suppressed, i.e. not visible in the PDF. See these [formatting guidelines] for code and tips to help you format your write up.
