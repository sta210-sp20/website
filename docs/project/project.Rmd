...
- **Final write up**: due Tue, Apr 28 at 11:59p
...
**Your presentation should be no longer than 10 minutes, and each team member should say something substantial.**

You will record a presentation (no longer than 10 minutes) and upload the recording and presentation slides to the discussion forum in Sakai. Both must be uploaded by **Mon, April 27 at 11:59p EDT**. 

The format of You can use any software you like to make the presentation, including R Markdown to create your slides. There isn't a limit to how many slides you can use, just a  time limit (10 minutes total). Each team member should get a chance to speak during 
the presentation. Your presentation should not just be an account of everything you  tried ("then we did this, then we did this, etc."), instead it should convey what  choices you made, and why, and what you found.

More tips about how to record the presentation will be provided at a later date. 

## Watch + comment on presentations (10 pt): Tue, April 28 - Wed, April 29

You will be assigned 3 presentations to watch. For each presentation, you will post a question to the discussion thread for the group to answer. You may not post a question that's already been asked on the discussion thread.

All questions must be posted by **Wed, April 29 at 11:59p EDT**. 

## Respond to questions (10 pt): Thu, April 30 - Fri, May 1

As a group, you will respond to the questions about your presentation. 

All responses must be submitted by **Fri, May 1 at 11:59p EDT**. 

#### Grading 

A rubric will be provided for the final presentation. 


## Final Write Up (30 pt): due Tue, Apr 28 at 11:59p
