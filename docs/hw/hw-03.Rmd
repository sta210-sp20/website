...
$$\hat{\text{speed}} = \beta_0 + \beta_1 \text{year} + \beta_2 \text{starters} + \beta_3 \text{good} + \beta_4 \text{slow} + \beta_5 (year \times good) + \beta_6 (year \times slow)$$  
...
4. What is the p-value for the test that mean winning speed is the same under fast track conditions and good track conditions (holding year and starters constant)? 

5. What is the p-value for the test that the slope year is the same for fast track conditions and good track conditions (holding year and starters constant)? 
