...
4. Use the model to interpret the 95% confidence interval in terms fo the interpret the 95% confidence intervals for the coefficients  of `distance` and `morphlight` in terms of the odds of a moth being removed.
