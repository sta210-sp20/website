...
author: "due Wednesday, September 18 at 11:59p"
date: ""
output: 
  html_document:
    css: "./sta210-hw.css"
...
9. Fit a regression model that could be used to predict the number of bike rentals based on the temperature during the **summer season**. Use your model to answer the following: 
    ...
    - In Washington D.C., the average temperature in the summer (June, July, August) is about 30 degrees Celsius (about 87 degrees Fahrenheit). Use your model to predict (1) the average number of bike rentals for the days in the summer that are 30 degrees Celsius and (2) the number of bike rentals we can expect if it's 30 degrees on a single day in June. 
