...
This dataset contains smoking habits and other demographic information for 1,691 randomly selected survey respondents in the United Kingdom. Click [here](https://www.openintro.org/data/index.php?data=smoking) for a full list of the variables in the data. We will use the following variables: 
