...
-  Given the structure of the data, you will approach the logistic regression in a slightly different way than what we've seen thus far.  Use `win_pct` to create a new variable that is the log odds of winning. Fit a linear model with this new variable as the repsonse.
