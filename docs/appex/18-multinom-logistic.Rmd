...
1. We will build a model to predictor how often a child in this study watched *Sesame Street*. What type of model should we build? Why? 
...
7. How would you describe assess the appropriateness of the model flit? Describe the plots, tables, and/or calculations you would create to assess model fit. 
