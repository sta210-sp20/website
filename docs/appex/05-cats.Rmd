...
- What assumption(s) can you assess from this scatterplot? Are these assumptions satisifed? Briefly explain. 
...
- What assumption(s) can you assess from the histogram and Normal QQ-Plot? Are these assumptions satisifed? Briefly explain. 

6. Comment on any other assumptions that haven't been addressed and whether they are satisifed. 
...
13. Calculate the 95% confidence interval for the predicted heart weight of an indiviudal cat that weighs 3.18 kg. Interpret the interval in context.
