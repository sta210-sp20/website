...
In this mini analysis, we will work with the `Advertising` data used in Chapters 2 and 3 of [Introduction to Statistical Learning](https://www-bcf.usc.edu/~gareth/ISL/).
