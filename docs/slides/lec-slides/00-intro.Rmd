...
<i class="material-icons">mail_outline</i> &nbsp;[anna.darwish@duke.edu](mailto:anna.darwish@duke.edu)<br>
...
<i class="material-icons">mail_outline</i> &nbsp;[abbas.zaidi@duke.edu](mailto:abbas.zaidi@duke.edu)<br>
<i class="material-icons">work_outline</i> &nbsp;Old Chem 203B<br>
<i class="material-icons">calendar_today</i>&nbsp; TBD
]
...
- [STA210 GitHub Site](https://github.com/STA210-Sp19)
...
- [An Introduction to Statistical Learning](https://www-bcf.usc.edu/~gareth/ISL/)
    - Free PDF on author's website. Hard copy available for purchase
...
- If you choose to use a laptop or tablet for note taking, please ensure that the volume is set to mute and the device is only used for class purposes. 
