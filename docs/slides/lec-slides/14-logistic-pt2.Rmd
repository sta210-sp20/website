...
This data is from an [ongoing cardiovascular study](https://framinghamheartstudy.org/fhs-about/) on residents of the town of Framingham, Massachusetts. The goal is to predict whether a patient has a 10-year risk of future coronary heart disease.
