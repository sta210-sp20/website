...
### Example: Calculating 90% confidence interval
...
- **Ex.**
  ...
  + odds a flier thinking reclining is rude: `r p_hat/(1-p_hat)` to 1
...
- The <font class="vocab3">odds ratio</font> is $\phi = \frac{\omega_1}{\omega_2}$
...
$$SE_0[\log(\hat{\phi})] =SE_0\bigg[\log\bigg(\frac{\hat{\omega}_1}{\hat{\omega}_2}\bigg)\bigg] = \sqrt{ \frac{1}{n_1\hat{\pi}_c(1-\hat{\pi}_c)} + \frac{1}{n_2\hat{\pi}_c(1-\hat{\pi}_c)}}$$
...
- **30 - 44**: $n_ =$ `r n[2]`, $\hat{\omega} =$ `r odds[2]`
