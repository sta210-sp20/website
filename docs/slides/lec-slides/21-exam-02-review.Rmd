...
- <font class="vocab">Intercept</font>: When $X_1 = \dots X_p =0$, the odds of $Y=k$ versus $Y=1$ are expected to be $\exp\{\hat{\beta}_{0k}\}$, holding all else constant.
...
.question[
- Write the equation for the odds of crab being from the Lb species.
...
.question[
1. Write the model for part of the model describing the odds of Hn vs. Cp species.
2. Interpret the intercept for this part of the model.
3. Interpret the coefficient of `Force` fort this part of the model.
]
