...
For the `advertising` data, we have the model 
...
--
    ...
    - Ex: Which type of media advertising generates the boost in sales?
...
--
    - <font class="vocab">Irreducible error: </font> Error that cannot be reduces even if the model, $\hat{f}$, is a perfect fit. In other words, this is variability associated with $\epsilon$
...
- [Reading 01](https://www2.stat.duke.edu/courses/Spring19/sta210.001/reading/reading-01.html)
