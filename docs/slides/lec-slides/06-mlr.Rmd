...
The largest variance $1889^2$ is `r round(1889^2/1465^2, 3)` times the smallest variance $1465^2$, so the constant variance assumption is satisified. 
...
### House prices in Levittown, NY (section 1.4)
