...
**To check function of predictors is well specified, i.e. the model fits the data well**
...
- If bins have average residuals with large magnitude
  ...
  + Interaction may be required if large residuals correspond to certain combinations of predictor variables
...
```{r}
arm::binnedplot(x=sleep_aug$ageCent,y=sleep_aug$.resid,xlab="Age", main = "Binned Residual vs. Age")
```
