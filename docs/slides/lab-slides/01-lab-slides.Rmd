...
### Submitting Assignments - Part 1

- Go to http://www.gradescope.com and click *Log in* in the top right corner. 

- Click "School Credentials" `r emo::ji("arrow_right")` Duke NetID and log in using your Net ID credentials.

- Click on the "STA 210 Regression Analysis" course, and click the "Lab 01" assignment. 

- Click the "Submit" button, and you will be asked to log into GitHub.

---

### Submitting Assignments - Part 2
...
- You can see what has been submitted by click "Code" at the top of the page. 
  - **We will be grading the PDF file**, so please make sure that has all of your final code, output, and narratives. 
  
- You are welcome to resubmit as many times as you'd like before the deadline. Just follow the steps above.
