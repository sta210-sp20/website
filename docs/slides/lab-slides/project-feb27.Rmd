...
You will briefly write about a dataset you'd like to use for the project in the file `project-ideas.Rmd`. This includes 

- Brief description of the observations / what the data is about
- Link to a data dictionary (or type one if none is available one)
...
- You will still need to complete the Topic Ideas assignment even if you are interested in this project
